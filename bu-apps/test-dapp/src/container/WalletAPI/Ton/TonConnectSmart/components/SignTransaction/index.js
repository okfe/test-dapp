  ...
  return (
    <Card title="SignTransaction">
      <Space direction="vertical" style={{ width: '100%' }}>
        <Button block disabled={!address} onClick={sendTon()}>
          sendTon
        </Button>
        ...
        <Button
          ...
          color="danger"
          disabled={!address}
          onClick={sendTon(tonBlackAddress)}
        >
          sendTon to Black Address
        </Button>

        <Button block disabled={!address} onClick={sendFish()}>
          sendFish
        </Button>
        ...
        <Button
          ...
          color="danger"
          disabled={!address}
          onClick={sendFish(tonBlackAddress)}
        >
